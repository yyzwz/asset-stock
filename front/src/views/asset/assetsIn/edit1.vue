    ...
    <Card>
        ...
        <Form ref="form" :model="form" :label-width="100" :rules="formValidate" label-position="left">
            <FormItem label="资产" prop="assetName">
                <Input v-model="form.assetName" clearable style="width:570px" disabled />
            </FormItem>
            <FormItem label="发票单号" prop="invoice">
                <Input v-model="form.invoice" clearable style="width:570px" />
            </FormItem>
            <FormItem label="型号" prop="model">
                <Input v-model="form.model" style="width:570px" disabled />
            </FormItem>
            <FormItem label="单价" prop="unitPrice">
                <Input v-model="form.unitPrice" style="width:570px" disabled />
            </FormItem>

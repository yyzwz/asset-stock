    ...
    <Card>
        ...
        <Form ref="form" :model="form" :label-width="100" :rules="formValidate" label-position="left">
            <FormItem label="资产名称" prop="assetName">
                <Input v-model="form.assetName" readonly style="width:570px" />
            </FormItem>
            <FormItem label="领用人" prop="recipients">
                <Input v-model="form.recipients" readonly style="width:570px" />
            </FormItem>
            <FormItem label="型号" prop="model">
                <Input v-model="form.model" readonly style="width:570px" />
            </FormItem>
            <FormItem label="单价" prop="unitPrice">
                <InputNumber v-model="form.unitPrice" readonly style="width:570px"></InputNumber>
            </FormItem>
            <FormItem label="数量" prop="number">
                <InputNumber v-model="form.number" readonly style="width:570px" @on-change="changeNumber" :min="0" :max="maxNumber"></InputNumber>
            </FormItem>
            <FormItem label="总价">
                <Input v-model="form.totalPrice" style="width:570px" readonly />
            </FormItem>
            <FormItem label="备注" prop="remarks">
                <Input v-model="form.remarks" readonly style="width:570px" />
            </FormItem>
            <Form-item class="br">

    ...
    <Card v-show="currView == 'index'">
        <Row v-show="openSearch" @keydown.enter.native="handleSearch">
            <Form ref="searchForm" :model="searchForm" inline :label-width="70">
                <Form-item label="耗材名称" prop="assetName">
                    <Input type="text" v-model="searchForm.assetName" placeholder="请输入耗材名称" clearable style="width: 200px" />
                </Form-item>
                <Form-item style="margin-left:-35px;" class="br">
                    ...
                    <Button @click="add" size="small" ghost type="primary" icon="md-add">添加</Button>
                    <Button @click="delAll" size="small" ghost type="error" icon="md-trash">删除</Button>
...
export default {
        ...
        return {
            ...
            columns: [{
                ...
                },
                {
                    ...
                    sortable: true,
                    render: (h, params) => {
                        if (params.row.existingNumber * 2 > params.row.number) {
                            return h("div", [
                                h(
                                    "span", {
                                        style: {
                        ...
                        } else if (params.row.existingNumber * 4 > params.row.number) {
                            return h("div", [
                                h(
                                    "span", {
                                        style: {
    ...
    methods: {
        ...
        getDataList() {
            this.loading = true;
            getAssetsTypeList(this.searchForm).then((res) => {
                this.loading = false;
                if (res.success) {
